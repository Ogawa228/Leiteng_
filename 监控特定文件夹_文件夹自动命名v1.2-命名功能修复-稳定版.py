...
class TrayApp(QObject):
    ...
    def start_monitoring(self):
        ...
        for target_path in self.target_paths:
            ...
            self.observer.schedule(event_handler, target_path, recursive=self.include_subfolders.get(target_path, False))
    ...
    def stop_auto_naming(self):
        ...
        if self.is_running:
            ...
            QMessageBox.information(None, '通知', '监控已停止')  # 弹出对话框告知用户监控已停止
    ...
    def update_naming_rules(self, rule):
        ...
        # 动态更新监控范围
        if self.is_running:
            self.start_monitoring()  # 重新启动监控，确保使用新的命名规则
    ...
    def on_checkbox_state_changed(self, state, item):
        ...
        if checkbox.isChecked():
            ...
            for i in range(item.childCount()):
                ...
                self.folder_states[child_item.text(1)] = True  # 更新子文件夹状态
        else:
            ...
            for i in range(item.childCount()):
                ...
                self.folder_states[child_item.text(1)] = False  # 更新子文件夹状态
        
        # 动态更新监控范围
        if self.is_running:
            self.start_monitoring()  # 重新启动监控，确保使用新的文件夹状态 
