...
###Add some variation to these
  ...
  ("comment_you_were_defeated_allied_1",                        "I heard that {s54} defeated you. But take heart -- the tables will soon be turned!"), 
  ...
  ("comment_you_were_defeated_allied_unfriendly_1",             "I heard that {s54} defeated you. Look, try not to get too many of our men killed, will you?"), 
...
#Post 0907 changes begin
  ...
  ("rebellion_agree_pitiless_1",              "You are fortunate. I have decided to join you. Pray do not give me cause to regret this decision."),
  ("rebellion_agree_cunning_1",               "This is a most dangerous decision, but after careful consideration, I have decided that I will join you. Let's hope it is for the best."),
  ("rebellion_agree_sadistic_1",              "I have decided. I will back your {reg3?woman:man} {s45}. But you'd best make sure that {reg3?she:he} rewards me well!"),
  ("rebellion_agree_goodnatured_1",           "All right. I think your {reg3?woman:man} will be a good ruler. I'll join you."),
  ("rebellion_agree_upstanding_1",            "So be it. My first duty is to this realm, and to save it from lawlessness I will back {s45} and renounce my homage to {s46}. May the Heavens forgive me if I do wrong."),
...
("the_coast", "the coast"),
  ...
  ("whereabouts_unknown_1", "whereabouts unknown"),
  
  ("none_yet_gathered", "{!}None yet gathered"),
  
  ("betrothed_1", " Betrothed "),
  ...
  ("s1_reg0_s2_2", "{!}{s1}, {reg0} {s2}"),
  ("s3_reg0_s2_2", "{!}{s3} {reg0} {s2}"),
  ("s1_s2_2", "{!}{s1} {s2}"),
...
("adimi_tool_game_start_message_1", "You are running Adimi Tools version {reg1}.{reg2}.{reg3} by Gotha."),
("adimi_tool_game_start_message_2", " "),#Must be space, otherwise it will crash: "unexpected strings.txt ending.."
