...
presentations = [
	#Adimi Tools game start 01-04-17
	("game_start",prsntf_read_only,0,[
      (ti_on_presentation_load,
		[
        
        (assign,reg1,"$adimi_tool_version_{}_X_X"),
		(assign,reg2,"$adimi_tool_version_X_{}_X"),
		(assign,reg3,"$adimi_tool_version_X_X_{}"),
	#	(set_show_messages, 1),
		(display_message,"str_adimi_tool_game_start_message_1",dark_red),
		(display_message,"str_adimi_tool_game_start_message_2",dark_red),
		(display_message,"str_adimi_tool_game_start_message_3",dark_red),
