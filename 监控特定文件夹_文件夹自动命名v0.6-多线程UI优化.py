...
class TrayApp(QObject):
    ...
    def show_settings_dialog(self):
        if self.settings_dialog is None:
            ...
            self.settings_dialog.resize(800, 600)  # 设置对话框宽度
            layout = QVBoxLayout()
            ...
            # 设置目录树标题字体
            header_font = QFont("微软雅黑", 12)
            header_font.setBold(True)
            self.folder_tree.header().setFont(header_font)
            self.folder_tree.header().setDefaultAlignment(Qt.AlignCenter)  # 标题居中
